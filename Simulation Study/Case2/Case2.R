...
########################################################
setwd("D:/Projects 3/Revision codes - Simulation/Case2")
dir()
##### Loading libraries ######
library(fields)
library(MASS)
...
######## intitalizing value #########
init.my.pars.mat.cross<-c(0.5,0.3,0.3,-0.147,-0.148,0,0,0,0)
...
######## intitalizing value #########
init.my.sep.mat.cross<-c(0.5,0.3,0.3,-0.147,-0.149,0,0,0,0)
...
init.liz.pars.mat.cross<-c(0.5,0.3,0.3,-0.147,-0.148,0,0)
...
######## intitalizing value #########
init.liz.sep.mat.cross<-c(0.5,0.3,0.3,-0.147,-0.149,0,0) 


###############################################################
# optim_loglik_liz_asym_sep.mat is an optimizer for mle_liz_asym_sep.mat_mlv over parameters (pars)
###############################################################
...
###############################################################
# optim_loglik_sym_pars.mat is an optimizer for mle_sym_pars.mat_mlv over parameters (pars)
###############################################################
...
###############################################################
# optim_loglik_sym_sep.mat is an optimizer for mle_sym_sep.mat_mlv over parameters (pars)
###############################################################
...
boxplot(l121,l122,l131,l132,l231,l232,col = "lightsteelblue",names = c(expression("\u2113"[12]['x']),expression("\u2113"[12]['y']),expression("\u2113"[13]['x']),expression("\u2113"[13]['y']),expression("\u2113"[23]['x']),expression("\u2113"[23]['y'])),las=1)
